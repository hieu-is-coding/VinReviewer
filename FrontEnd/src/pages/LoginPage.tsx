...
function OrDivider() {
  return (
    <div className="flex items-center gap-3 my-5">
      ...
      <span className="text-xs text-slate-500 font-medium tracking-wider uppercase">or</span>
      <div className="flex-1 h-px bg-white/10" />
    </div>
  );
}
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" id="signin-form">
      ...
      <button
        ...
        className="w-full h-11 rounded-xl flex items-center justify-center gap-3 border border-white/20 bg-white/5 hover:bg-white/10 text-white text-sm font-medium transition-all duration-200 disabled:opacity-60"
      >
        {googleLoading ? (
