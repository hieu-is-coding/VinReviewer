...
from src.synthesis.output import save_report
...
def rebut(argv: list[str] | None = None) -> None:
    ...
    from src.models import LeafVerdict, RebuttalEntry, ReviewOutput
    from src.rebuttal.handler import process_rebuttals
