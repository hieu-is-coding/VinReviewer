...
from src.agents.critic import run_evidence_audit
from src.agents.novelty import assess_novelty
from src.agents.objective import build_rubric_tree
from src.agents.retrieval import retrieve_literature
from src.agents.supervisor import check_red_lines
from src.calibration.calibrator import apply_calibration, load_calibration
from src.calibration.comparative import compute_comparative_position
from src.features.normalize import normalize_features
from src.features.references import validate_references
from src.features.router import extract_all_features
from src.ingest.pipeline import ingest
from src.models import PipelineState, SupervisorResult
from src.synthesis.deliberation import run_deliberation
...
def _node_synthesis(state: dict[str, Any]) -> dict[str, Any]:
    ...
    from src.models import ReviewOutput
    review = ReviewOutput(
