...
from src.synthesis.prompt import _build_user_message
...
def run_deliberation(
    ...
    *,
    ...
    """Run multi-persona review generation and deliberation.
    ...
    for persona in personas:
        logger.info("Generating %s persona review", persona)
        review = _generate_persona_review(
            persona,
            manuscript,
            rubric_tree,
            features,
